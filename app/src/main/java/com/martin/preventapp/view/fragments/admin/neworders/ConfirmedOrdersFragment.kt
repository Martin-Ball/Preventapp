...
class ConfirmedOrdersFragment : Fragment(), ConfirmedOrderInterface.listener {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val items = listOf(
            OrderItem("Pedido 1", listOf(Product("Producto 1",1212.11), Product("Producto 12", 1212.11), Product("Producto 12", 1212.11), Product("Producto 12", 1212.11), Product("Producto 12", 1212.11), Product("Producto 12", 1212.11), Product("Producto 12", 1212.11), Product("Producto 12", 1212.11),), Client("Cliente 1"), "Preventista 1", "nota de pedido"),
